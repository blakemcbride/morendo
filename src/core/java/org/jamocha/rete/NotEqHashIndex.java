...
/**
 * @author Peter Lin
 *     <p>NotEqHashIndex is different from EqHashIndex is 2 ways. The first is it only uses the
 *     values of equality comparison and ignores the not equal values. The second is it takes
 *     BindValue[] instead of just Object[].
 */
public class NotEqHashIndex implements HashIndex {
    ...
    /**
     * The implementation is different than EqHashIndex. It ignores any Bindings that are negated
     */
