...
/**
 * Where the engine's printed output goes: every message is posted to the message router
 * (which delivers it to the shell or GUI channel that is executing a command) and to every
 * registered writer, such as a (spool) file. Owned by Rete.
 */
public class EngineOutput {
	...
	public void write(String msg, String output) {
		...
		router.postMessageEvent(new MessageEvent(MessageEvent.Type.ENGINE, msg,
