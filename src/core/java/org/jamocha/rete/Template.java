...
/**
 * @author Peter Lin
 *     <p>Template defines the methods to access an object, which is the equivalent of un-ordered
 *     facts. It defines all the necessary methods for Deftemplate.
 */
public interface Template extends Serializable, Print {
    ...
    /**
     * templates may have 1 or more slots. A slot is a named column with a specific type of value.
     *
     * @return
     */
    ...
    /**
     * if watch is set to true, the rule engine will pass events when the fact traverses the
     * network.
     *
     * @return
     */
    ...
    /**
     * If a template has a parent, the method should return the parent, otherwise it should return
     * null
     *
     * @return
     */
    ...
    /**
     * If the template is currently in use, we should not remove it until all the dependent rules
     * are removed first.
     *
     * @return
     */
