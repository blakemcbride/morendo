...
/**
 * @author Peter Lin
 *     <p>the class contains utilities for doing things like sortig the facts for printing.
 */
public class FactUtils {

    public static final FactComparator COMPARATOR = new FactComparator();
    public static final FactTemplateComparator TEMPLATECOMP = new FactTemplateComparator();
