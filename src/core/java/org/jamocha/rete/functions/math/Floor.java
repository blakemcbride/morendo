 ...
 * @author Peter Lin
 *     <p>Floor returns the greatest integer smaller or equal to a value.
 */
    ...
    public ReturnVector executeFunction(Rete engine, Parameter[] params) {
        ...
        if (params != null) {
            for (int idx = 0; idx < params.length; idx++) {
                ...
                if (bd.doubleValue() > 0) bdval = BigDecimal.valueOf(bdval.intValue());
                else if (bd.doubleValue() < 0) bdval = BigDecimal.valueOf(bdval.intValue() - 1);
            }
        }
