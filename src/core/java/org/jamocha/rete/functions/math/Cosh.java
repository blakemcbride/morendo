 ...
 * @author Peter Lin
 *     <p>Returns the hyperbolic cosine of an angle.
 */
public class Cosh implements Function {
    ...
    public String toPPString(Parameter[] params, int indents) {
        if (params != null && params.length >= 0) {
            ...
            return "(cosh <literal> | <binding>)\n"
                    + "Function description:\n"
                    + "\tCalculates the hyperbolic cosine of the numeric argument.\n"
