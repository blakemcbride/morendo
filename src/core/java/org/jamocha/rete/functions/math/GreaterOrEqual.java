...
/**
 * @author Peter Lin
 *     <p>GreaterOrEqual will compare 2 or more numeric values and return true if the (n-1)th value
 *     is greater or equal than the nth.
 */
public class GreaterOrEqual implements Function {
