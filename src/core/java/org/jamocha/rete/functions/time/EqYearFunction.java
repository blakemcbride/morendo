 ...
 * @author Peter Lin
 */
public class EqYearFunction extends AbstractTimeFunction implements Function {

	/**
	 * 
	 */
	public static final String EQ_YEAR = "eq-year";
	
	public EqYearFunction() {
		super();
	}
