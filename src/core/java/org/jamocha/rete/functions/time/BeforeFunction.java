...
/**
 * Before function is used to evaluate 2 time values. The time can be a date, calendar or long
 * millisecond time. It isn't meant to be used to be used for Conditional Elements like (before
 * (date (day "tuesday") ) ). That type of logic is difficult to support and problematic. Until
 * someone figures out an efficient way to implement that type of temporal logic safely, efficiently
 * and reliably, it will remain impractical.
 *
 ...
 * @author Peter Lin
 */
public class BeforeFunction extends AbstractTimeFunction implements Function {
    ...
    public String toPPString(Parameter[] params, int indents) {
        if (params != null && params.length > 0) {
            ...
            return "(before <time1> <time2>) \r the first time is before the second time.";
        }
    }
}
