...
/**
 * @author Peter Lin
 *     <p>Generate facts will call the utility class with the Rule object and return an Object[]
    ...
    public ReturnVector executeFunction(Rete engine, Parameter[] params) {
        ...
        if (params != null && params.length >= 1) {
            ...
            if (facts.size() > 0) {
                ...
                DefaultReturnValue rv = new DefaultReturnValue(ValueType.OBJECT, facts.toArray());
