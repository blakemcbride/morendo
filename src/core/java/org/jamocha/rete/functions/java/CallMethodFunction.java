...
/**
 * Call method for invoking arbitrary java methods. The function uses defclass to find the method,
 * since that is the entry point for java classes.
 *
 * @author Peter Lin
 */
public class CallMethodFunction implements Function {
    ...
    /**
     * By default, the function returns Object type. Since the function can be used to call any
     * number of getXXX methods and we wrap all primitives in their object equivalent, returning
     * Object type makes the most sense.
     */
        ...
        if (engine != null && params != null && params.length >= 2) {
            ...
            if (dc != null) {
                ...
                if (callm != null) {
                    try {
                        ...
                        rvalue =
                                new DefaultReturnValue(
                                        ValueType.STRING,
                                        "IllegalAccessException: could not invoke the method due to"
                                                + " access privledge");
                    ...
                    rvalue =
                            new DefaultReturnValue(
                                    ValueType.STRING, "Unknown method " + slot.getStringValue());
            } else
                rvalue =
                        new DefaultReturnValue(
                                ValueType.STRING,
     ...
     * BoundParam - the bound object StringParam - the slot name ValueParam - the value to set the
     * field <br>
    ...
    /**
     * For now, this utility method is here, but maybe I should move it to some place else later.
     *
     * @param m
     * @return
     */
