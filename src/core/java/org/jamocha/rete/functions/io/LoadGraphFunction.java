...
/**
 * @author Peter Lin
 *     <p>LoadGraph is designed to load graph data that uses the built-in graph model. The function
 *     returns a list of facts, which can be bound to a variable. Once the graph data is loaded, you
 *     can use it with a graph query.
 */
public class LoadGraphFunction implements Function {
    ...
    public ReturnVector executeFunction(Rete engine, Parameter[] params) {
        ...
        List<Deffact> facts = new ArrayList<>();
        ...
        DefaultReturnValue drv = new DefaultReturnValue(ValueType.OBJECT, farray);
