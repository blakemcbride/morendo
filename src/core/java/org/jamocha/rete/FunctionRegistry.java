 ...
 * {@link #loadBuiltIns()}; the gui and messaging modules contribute theirs by listing
 * the group class in META-INF/services/org.jamocha.rete.FunctionGroup
 * (java.util.ServiceLoader), which any other jar can do as well; groups can also be
 * declared at run time with {@code (load-function-group ...)} / {@link Rete#declareFunctionGroup}.
...
public class FunctionRegistry {
	...
	void loadBuiltIns() {
		FunctionGroup[] builtIns = { new AnalysisFunctions(), new BitFunctions(),
				...
				new RuleEngineFunctions(), new QueryFunctions(),
