...
/**
 * @author Peter Lin
 *     <p>Class extends QueryBaseNot, since it works the same way as Not CE for defqueries.
 */
public class QueryOnlyJoin extends QueryBaseNot {
    ...
    public QueryBaseJoin clone(Rete engine, Defquery query) {
        QueryOnlyJoin clone = new QueryOnlyJoin(engine.nextNodeId());
