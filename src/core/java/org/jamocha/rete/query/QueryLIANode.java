...
/**
 * LIANode stands for Left Input Adapter Node. Left input adapter node can only only have 1
 * alphaNode above it. Left input adapater nodes are not shared by multiple branches of the network,
 * so it doesn't have any memory.
 *
 * @author Peter Lin
 */
