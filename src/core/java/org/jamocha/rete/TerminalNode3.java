 ...
 *     have it set, we don't bother checking. If it does, we make sure a new activation is added
 *     only if the rule is within the the two dates.
 */
public class TerminalNode3 extends TerminalNode2 {
    ...
    /**
     * The implementation tries to remove the activation and doesn't check the effective and
     * expiration date. this is just in case the engine is running near midnight. If the activation
     * was added right before mid night, we still need to remove it to be safe.
     *
     * @param facts
     * @param engine
     */
