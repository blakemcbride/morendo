...
/**
 * @author Peter Lin AbstractParam provides the common implementation of Parameter interface.
 */
public abstract sealed class AbstractParam implements Parameter
    ...
    /**
     * the implementation will check if the value is a String. if it is, it casts the object to a
     * String, otherwise it calls the object's toString() method.
     */
