...
/**
 * @author Peter Lin
 *     <p>Basic interface for activation. There may be more than one implementation of Activation.
 *     The important thing about the activation is it knows which facts trigger a single rule.
 */
public interface Activation {
    ...
    /**
     * If the activation passed in the parameter has the same rule and facts, the method should
     * return true
     *
     * @param act
     * @return
    ...
    /**
     * When watch activation is turned on, we use the method to print out the activation.
     *
     * @return
     */
    String toPPString();
