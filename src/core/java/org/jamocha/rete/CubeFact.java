...
public class CubeFact implements Fact {
    ...
    /**
     * the method generates the definition of the Cube and doesn't populate it with actual values.
     * Since a cube could have a lot of data, populating it with all the data would be huge. That
     * isn't practical.
     */
    ...
    /**
     * Since a CubeFact wraps a Cube instance, they are considered equal if the underlying Cube is
     * the same. Not it doesn't compare the slots like deffact.
     */
    ...
    public ResultsetFact createResultsetFact(Rete engine) {
        ...
        ResultsetFact fact =
                new ResultsetFact(this.template, this.objInstance, newSlots, engine.nextFactId());
        return fact;
    }
}
