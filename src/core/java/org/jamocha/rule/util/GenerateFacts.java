...
/**
 * @author Peter Lin
 *     <p>The class will generate the trigger facts for a single rule. The purpose of this is to
 *     make it easier to test a rule. Since a rule knows what conditions it needs, it makes sense to
...
public class GenerateFacts {
    ...
    /**
     * The method uses Defclass, Class, Deftemplate and Rete to create a new instance of the java
     * object. Once the instance is created, the method uses Defclass to look up the write method
     * and calls it with the appropriate value.
     *
     * @param cond
     * @param templ
     * @param engine
