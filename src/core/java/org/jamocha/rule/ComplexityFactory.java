...
/**
 * ComplexityFactory makes it easier to configure the rule engine to use different implementations
 * of complexity calculation. When the rule engine starts, it should get the Class object and set
 * the factory appropriately.
 *
 * @author Peter Lin
 */
