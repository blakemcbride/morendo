...
/**
 * @author Peter Lin
 *     <p>A TestCondition is a pattern that uses a function. For example, in CLIPS, (test (> ?var1
 *     ?var2) )
 */
public final class TestCondition implements Condition {
    ...
    /**
     * the current implementation creates a new ArrayList, adds the TestNode to it and returns the
     * list.
     */
    ...
    /**
     * The current implementation checks to make sure the node is a TestNode. If it is, it will set
     * the node. If not, it will ignore it.
     */
    ...
    /** return an List of the bindings. in the case of TestCondition, the bindings are BoundParam */
