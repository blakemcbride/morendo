...
/**
 * @author Peter Lin
 *     <p>BoundConstraint is a basic implementation of Constraint interface for bound constraints.
 *     When a rule declares a slot as a binding, a BoundConstraint is used.
 */
public final class BoundConstraint implements Constraint {
    ...
    /** In the case of BoundConstraints, the value is the name of the variable given my the user */
    ...
    /** if the binding is for a multislot, it should be set to true. by default, it is false. */
    ...
    /**
     * Be default a variable binding is accessible from the action of the rule unless it's declared
     * by a conditional element that does not propagate changes down the RETE network.
     */
    ...
    /**
     * The value is the name of the variable. In the case of CLIPS, if the rule as "?name", the
     * value returned is "name" without the question mark prefix.
     */
    ...
    /**
     * The input parameter should be a string and it should be the name of the variable. Make sure
     * to parse out the prefix. For example, CLIPS uses "?" to denote a variable.
     */
    ...
    /**
     * if the binding is for a multislot, it will return true. by default is is false.
     *
     * @return
     */
    ...
    /**
     * if the literal constraint is negated with a "~" tilda, call the method pass true.
     *
     * @param negate
     */
    ...
    /**
     * NOTCE, Exists CE and Multiple CE should set binding to false, since the action of the rule
     * cannot bind to the declared variables.
     *
     * @param exists
     */
    ...
    /**
     * If the constraint is accessible from the action of the rule, the variable should be set to
     * bindable.
     *
     * @return
     */
