...
/**
 * @author Peter Lin
 *     <p>Literal constraint is a comparison between an object field and a concrete value. for
 *     example, account.name is equal to "Peter Lin". I originally, named the class something else,
 *     but since CLIPS uses literal constraint, I decided to change the name of the class. Even
 *     though I don't like the term literal constraint, it doesn't make sense to fight existing
 *     terminology.
 */
public final class AndLiteralConstraint implements Constraint {
    ...
    /** Set the value of the constraint. It should be a concrete value and not a binding. */
