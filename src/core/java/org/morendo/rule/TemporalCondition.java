...
/**
 * @author Peter Lin
 *     <p>TemporalCondition extends AbstractCondition and adds 2 additional attributes: relativeTime
 *     and varname. Since all temporal nodes have to have both, we make it easier to set and get.
 */
public final class TemporalCondition extends ObjectCondition {
    ...
    public String toPPString() {
        ...
        if (negated) {
            buf.append(
                    pad + pad + "(relative-time " + this.relativeTime + ")" + Constants.LINEBREAK);
        } else {
