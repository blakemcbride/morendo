...
/**
 * The default implementation of complexity calculation is straight forward. Here is the algorithm.
 *
 * <ul>
 *   <li>add 1 for each conditional element
 *   <li>add 1 for literal or predicate constraints
 *   <li>add 2 for each binding
 *   <li>add 2 for negated ce or existential ce
 *   <li>add 2 for test ce
 * </ul>
 *
 * @author Peter Lin
 */
