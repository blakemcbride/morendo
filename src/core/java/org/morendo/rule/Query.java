...
/**
 * @author Peter Lin
 *     <p>The query interface defines the attributes for a query class. The main difference between
 *     a rule and query is that queries do not have actions. Instead, it simply gathers the results
 *     and returns an ArrayList. Queries also do not have the same properties as a rule.
 */
