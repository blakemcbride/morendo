...
import org.morendo.rete.functions.cube.CubeAddDataFunction;
import org.morendo.rete.functions.cube.CubeDeleteDataFunction;
...
public class Defcube implements Cube {
    ...
    private Map<String, Object> bindingsByName = null;
    private Deftemplate[] templates = null;
    private Map<Index, Index> dataset = null;
    private Map<String, Object> dimensionMap = null;
    private Map<String, Object> dimensionMapByBinding = null;
    ...
    /** Add data to the cube. It expects a fact array from the generated cube rule. */
    ...
    /**
     * Method iterates over the dimensions and indexes the data. First is creates a new instance of
     * Index with the fact array, then it calls Dimension.indexData(Fact,Rete).
     *
     * @param data
     * @param engine
     */
    ...
    public boolean compileCube(Rete engine) {
        ...
        for (int idx = 0; idx < objectConditionList.size(); idx++) {
            ...
            Deftemplate templ =
                    (Deftemplate) engine.getCurrentFocus().getTemplate(oc.getTemplateName());
            if (templ == null) {
                return false;
            }
    ...
    /**
     * compileObject bindings is responsible for iterating over the ObjectConditions and creating
     * the bindings
     */
        ...
        for (int idx = 0; idx < this.defmeasures.length; idx++) {
            ...
            if (msr != null) {
                ...
                CubeDimension dimension =
                        (CubeDimension) dimensionMapByBinding.get(dmeasure.getVariableName());
                if (dimension != null) {
