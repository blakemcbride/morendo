...
/**
 * @author Peter Lin
 *     <p>TestNode extends BaseJoin. TestNode is used to evaluate functions. It may use values or
 *     bindings as parameters for the functions. The left input is where the facts would enter. The
 *     right input is a dummy input, since no facts actually enter.
 */
public class TestNode extends BaseJoin {
     ...
     * @param id
     */
    public TestNode(int id, Function func, Parameter[] parameters) {
        super(id);
        this.func = func;
    ...
    /**
     * Assert will first pass the facts to the parameters. Once the parameters are set, it should
     * call execute to get the result.
     */
