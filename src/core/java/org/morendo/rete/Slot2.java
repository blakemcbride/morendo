...
import org.morendo.rule.MultiValue;
...
/**
 * @author Peter Lin
 *     <p>Slot2 is used for conditions that evaluate against multiple values. For example: (attr2
 *     "me" | "you" | ~"her" | ~"she") <br>
 *     Rather than evaluate a long sequence of equal/not equal sequentially, we use two lists: equal
 *     and notequal. Slot2 is used exclusive for a sequence of "or" value comparisons.
 */
public class Slot2 extends Slot {
    ...
    /**
     * method will check to see if the object is a collection. if it is, it will iterate over the
     * collection and add each one to the right list.
     *
     * @param val
     */
