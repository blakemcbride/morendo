...
public class Defdimension implements CubeDimension {
    ...
    /**
     * Current implementation gets the value for the left row + column and creates a token index.
     * This is inspired by sybase IQ, which is a column based database.
     */
    ...
    /** method will only return data if the value is an instance of Number of a subclass. */
