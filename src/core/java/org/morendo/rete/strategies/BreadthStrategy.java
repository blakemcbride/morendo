...
/**
 * @author Peter Lin
 *     <p>Breadth strategy is very similar to CLIPS breadth strategy. The design of Strategies in
 ...
 *     these concepts, the design and implementation is quite different. Breadth strategy is often
 *     referred to as FIFO (First In First Out). What this means in practice is that matches with
 *     older facts will be executed before matches with newer facts. By executed, we mean the
 *     actions of the rule will be executed. CLIPS beginner guide provides a clear explanation of
 *     breadth: 5.3.2 Breadth Strategy Newly activated rules are placed below all rules of the same
 *     salience.
 */
