...
/**
 * @author Peter Lin
 *     <p>OnlyJoin is a specialized version of exists join that is satified if only 1 match is
 *     found.
 */
public class OnlyJoin extends BaseJoin {
     ...
     * @param engine
     */
    public void retractLeft(Index inx, Rete engine, WorkingMemory mem) throws RetractException {
        Map<?, ?> leftmem = mem.getBetaLeftMemory(this);
