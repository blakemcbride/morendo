...
/**
 * The key under which alpha nodes are shared: a slot name, the comparison operator and the literal
...
public record CompositeIndex(String name, Operator operator, Object value) {
    ...
    public boolean equals(Object other) {
        return this == other
                || (other instanceof CompositeIndex ci
                        && ci.name.equals(name)
                        && ci.operator == operator
                        && Objects.equals(ci.value, value));
    }
