...
/**
 * @author Peter Lin
 *     <p>NoAgendaTNode2 is similar to NoAgendaTNode with one difference. The rule may be deploy,
 *     but isn't effective until a given time. The terminal node will only create the activation if
 *     the current time is between the effective and expiration date of the rule.
 */
