...
/**
 * @author Peter Lin
 *     <p>LessOrEqual will compare 2 or more numeric values and return true if the (n-1)th value is
 *     less or equal to the nth value.
 */
public class LessOrEqual implements Function {
