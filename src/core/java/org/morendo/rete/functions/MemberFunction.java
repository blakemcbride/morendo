...
import org.morendo.rete.functions.java.ClassnameResolver;
 ...
 *     <p>Calls a method of a specified object.
 */
    ...
    public ReturnVector executeFunction(Rete engine, Parameter[] params) {
        ...
        if (params != null) {
            ...
            if (params[1] instanceof ValueParam) {
                ...
                methodname = (String) engine.getBinding(bp.getVariableName());
        ...
        DefaultReturnValue rv = new DefaultReturnValue(ValueType.OBJECT, ro);
