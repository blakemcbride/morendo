...
/**
 * @author Peter Lin
 *     <p>BoundParam is a parameter that is a binding. The test node will need to call
...
public final class BoundParam extends AbstractParam {
    ...
    /**
     * Column refers to the column of the fact. the value of the column should be a non-negative
     * integer.
     */
    ...
    /**
     * The TestNode should call this method to set the fact. The fact should never be null, since it
     * has to have matched preceding patterns. We may be able to remove the check for null. If the
     * row id is less than zero, it means the binding is an object binding.
     *
     * @param facts
     */
    ...
    /**
     * if the binding is bound to an object, the method will return true. By default, the method
     * will return false.
     *
     * @return
     */
