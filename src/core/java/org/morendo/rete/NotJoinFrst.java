...
/**
 * @author Peter Lin
 *     <p>NotJoinFrst is a special node for rules that have NOTCE for the first CE. The node does
 *     not propogate the initial fact down the network.
 */
public class NotJoinFrst extends BaseJoin {
    ...
    /**
     * In the case where the first condition element is a NOTCE, the left input is always going to
     * be the initial fact.
     *
     * @param factInstance
     * @param engine
