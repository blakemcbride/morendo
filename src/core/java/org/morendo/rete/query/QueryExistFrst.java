...
/**
 * QueryExistFrst is a special implementation for situations when the first Conditional Element is
 * an Exists. The main difference is the left input is a dummy and doesn't do anything. This gets
 * around the need for an InitialFact when the first conditional element is Exists.
 *
 * @author Peter Lin
 */
