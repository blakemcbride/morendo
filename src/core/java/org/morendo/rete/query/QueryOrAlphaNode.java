 ...
 * @author Peter Lin
 */
public class QueryOrAlphaNode extends QueryBaseAlphaCondition {
    ...
    public boolean evaluate(Fact factInstance) {
        boolean not =
                ((Slot2) this.slot)
                        .getNotEqualList()
                        .contains(factInstance.getSlotValue(this.slot.getId()));
        boolean eq =
                ((Slot2) this.slot)
                        .getEqualList()
                        .contains(factInstance.getSlotValue(this.slot.getId()));
