...
/**
 * QueryNotJoin is different than the normal RETE version. This is because of how queries work. The
 * NOTCE nodes for queries have to call an additional method named executeJoin to propogate down the
 * network after all the alpha nodes have been evaluated.
 *
 * @author Peter Lin
 */
public class QueryNotJoin extends QueryBaseNot {
     ...
     * objects, we need to pass all previously matched facts. For queries, do not propogate during
     * assert.
     *
     * @param factInstance
     * @param engine
