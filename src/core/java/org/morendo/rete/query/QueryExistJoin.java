...
/**
 * QueryExistJoin is implemented differently than how CLIPS does it. According to CLIPS beginners
 * guide, Exist is convert to (not (not (blah) ) ). Rather than do that, we have a specialized exist
 * node.
 *
 * @author Peter Lin
 */
