...
/**
 * QueryExistNeqJoin is a specialized node for handling existential patterns without translating it
 * to (not (not (ce) ) ). The implementation uses hashed memories for != joins.
 *
 * @author Peter Lin
 */
