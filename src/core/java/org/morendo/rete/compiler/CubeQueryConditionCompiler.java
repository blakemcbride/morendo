...
import org.morendo.rete.CubeQueryBNode;
import org.morendo.rete.CubeTemplate;
import org.morendo.rete.DefaultQueryCompiler;
import org.morendo.rete.DefaultRuleCompiler;
import org.morendo.rete.DimensionSlot;
...
public class CubeQueryConditionCompiler extends AbstractConditionCompiler {
    ...
    /** CubeQuery conditional elements will never have alpha nodes. The method is not implemented */
    ...
    public QueryBaseJoin compileJoin(
            Condition condition, int position, Query rule, Condition previousCond) {
        ArrayList<CubeBinding> dbindings = new ArrayList<>();
        ArrayList<CubeBinding> mbindings = new ArrayList<>();
        getCubeBindings(condition, rule, position, dbindings, mbindings);
        ObjectCondition oc = (ObjectCondition) condition;
    ...
    public void getCubeBindings(
            Condition condition,
            Rule rule,
            int position,
            ArrayList<CubeBinding> dimensionBinding,
            ArrayList<CubeBinding> measureBinding) {
