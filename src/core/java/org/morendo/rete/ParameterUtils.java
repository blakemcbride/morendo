...
public class ParameterUtils {
    /**
     * The method takes a list containing Parameters and converts it to an array of Parameter[]. Do
     * not pass a list with other types
     *
     * @param list
     * @return
     */
    ...
    /**
     * slotToParameters is a convienant utility method that converts a list containing parameters
     * and Slots to an array of Parameter[]. The method is used by the parser to handle modify
     * statements.
     *
     * @param list
     * @return
