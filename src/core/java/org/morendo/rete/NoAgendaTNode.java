...
/**
 * @author Peter Lin
 *     <p>NoAgendaTNode is different than TerminalNode2 in that it doesn't get added to the agenda.
 *     Instead, it fires immediately.
 */
public class NoAgendaTNode extends TerminalNode2 {
    ...
    /**
     * method does not apply, since the activation fires immediately, there's nothing to remove from
     * the agenda
     *
     * @param facts
     * @param engine
