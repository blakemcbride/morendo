package org.morendo.rete.fuzzy;

import java.util.HashMap;

/**
 * FuzzyBinding is similar to FuzzyJ FuzzyVariable class. Since we call variables bindings, it makes
 * sense to keep the same naming convention. The reason is that Clips called them bindings.
 *
 * @author peter
 */
public class FuzzyBinding implements Cloneable {
    ...
    private String
            unitType; // the user can define what ever type they want for units like C for celsius
