...
public class StandardDeviationMeasure implements AggregateMeasure {
    ...
    /**
     * The current implementation uses the following equation for standard deviation. s2 = S(x -
     * m)2/N x - data value m - mean N - number of data elements S - the set of s2 - deviation
     * squared
     *
     * @param engine
     * @param cube
