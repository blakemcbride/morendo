...
public class CubeQueryBNode extends BaseJoin {
    ...
    /**
     * Since a Cube is asserted when it is defined, it will always propagate down the network before
    ...
    /**
     * Retracting left uses EqHashIndex to look up the cached fact and propagates it down the
     * network. Note there's going to be only 1 ResultsetFact for a given EqHashIndex.
     *
     * @param factInstance
     * @param engine
     */
    ...
    /**
     * Retract right removes all partial matches, since there's only going to be 1 instance of the
     * cube
     *
     * @param factInstance
     * @param engine
