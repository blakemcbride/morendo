...
/**
 * @author Peter Lin
 *     <p>We test the BetaNode to make sure it works correctly.
 */
public class NotNodeTest {
    ...
    /**
     * test the NotJoin with facts that don't match. Each BetaMemory should have a match count of
     * zero.
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    @Test
    ...
    /**
     * the test creates a NotJoin and adds a BetaNode as a successor. it then asserts 10 facts and
     * makes sure the facts are propogated to the BetaNode.
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    @Test
    ...
    /** method will make sure the correct number of facts are asserted, propogated and retracted. */
    @SuppressWarnings({"rawtypes", "unchecked"})
    @Test
    ...
    /**
     * This test makes sure that when facts are asserted, only the first results in retract
     * propogation. this is because NotJoin should only propogate assert and retract when the match
     * count goes from zero to one or one to zero.
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    @Test
