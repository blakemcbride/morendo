...
public class MemoryBenchmark {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(
                "Used memory after creating engine " + used2 + " bytes " + (used2 / 1024) + " Kb");
        ...
        try {
            ...
            System.out.println(
                    "Used memory after loading rules, data and asserting facts "
                            + used3
                            + " bytes "
                            + (used3 / 1024)
                            + " Kb "
                            ...
                            + " Mb");
            System.out.println(
                    "elapsed time to parse and assert the data " + (end - start) + " ms");
