...
public class SimpleDataGenerator {
    ...
    // 8 issuers
    public static final String[] issuers = {"AAA", "BBB", "CCC", "DDD", "EEE", "FFF", "GGG", "HHH"};

    // 7 exchanges
    public static final String[] exchange = {
        "NYSE", "NSDQ", "LNSE", "TKYO", "TWSE", "PSEX", "RMSE"
    };

    // 6 cusips
    public static final String[] cusips = {
        "576335338", "847737565", "584420736", "776465086", "280242230", "334158152"
    };
