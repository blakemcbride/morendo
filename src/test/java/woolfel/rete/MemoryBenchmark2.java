...
import org.morendo.rete.functions.AssertFunction;
...
public class MemoryBenchmark2 {
    ...
    public static void main(String args[]) {
        ...
        int loopcount = 5;
        System.out.println(
                "Used memory before creating engine " + used1 + " bytes " + (used1 / 1024) + " Kb");
        for (int loop = 0; loop < loopcount; loop++) {
            ...
            System.out.println(
                    "Used memory after creating engine "
                            + used2
                            + " bytes "
                            + (used2 / 1024)
                            + " Kb");
            ...
            try {
                ...
                System.out.println(
                        "Used memory after loading rules, and parsing data "
                                + (used3 / 1024)
                                + " Kb "
                                + (used3 / 1024 / 1024)
                                + " Mb");
                System.out.println("elapsed time to parse the rules and data " + el + " ms");
                ...
                System.out.println("");
                System.out.println("Number of facts - " + engine.getDeffactCount());
                System.out.println("Time to assert facts " + et2 + " ms");
                System.out.println(
                        "Used memory after assert "
                                + (used4 / 1024)
                                + " Kb "
                                + (used4 / 1024 / 1024)
                                + " Mb");
