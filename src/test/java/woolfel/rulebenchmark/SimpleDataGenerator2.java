...
public class SimpleDataGenerator2 {
    ...
    // 5 exchanges
    public static final String[] exchange = {"NYSE", "NSDQ", "LNSE", "TKYO", "TWSE"};

    // 50 country codes
    public static final String[] countries = {
        "ad", "ae", "af", "ag", "ai", "al", "am", "an", "ao", "aq", "ar", "as", "at", "au", "aw",
        "az", "ba", "bb", "bd", "be", "bf", "bg", "bh", "bi", "bj", "bm", "bn", "bo", "br", "bs",
        "bt", "bv", "bw", "by", "bz", "ca", "cc", "cf", "cd", "cg", "ch", "ci", "ck", "cl", "cm",
        "cn", "co", "cr", "cs", "cu"
    };
    ...
    // 72 issuers
    public static final String[] issuers = {
        "AAA", "BBB", "CCC", "DDD", "EEE", "FFF", "GGG", "HHH", "III", "JJJ", "KKK", "LLL", "MMM",
        "NNN", "OOO", "PPP", "QQQ", "RRR", "SSS", "TTT", "UUU", "VVV", "WWW", "XXX", "ABA", "ABB",
        "ACC", "ADD", "AEE", "AFF", "AGG", "AHH", "AII", "AJJ", "AKK", "ALL", "AMM", "ANN", "AOO",
        "APP", "AQQ", "ARR", "ASS", "ATT", "AUU", "AVV", "AWW", "AXX", "BAA", "BAB", "BCC", "BDD",
        "BEE", "BFF", "BGG", "BHH", "BII", "BJJ", "BKK", "BLL", "BMM", "BNN", "BOO", "BPP", "BQQ",
        "BRR", "BSS", "BTT", "BUU", "BVV", "BWW", "BXX"
    };
    ...
    public static void main(String[] args) {
        if (args != null && args.length > 0) {
            ...
            System.out.println("no parameter were provided");
