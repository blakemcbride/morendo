...
public class GenerateJoinCountRules {
    ...
    public void write1JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
    ...
    public void write2JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("  (object1" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
    ...
    public void write3JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
            buf.append("    (shortfield " + shrtvar + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
    ...
    public void write4JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
            buf.append("    (shortfield " + shrtvar + ")" + Constants.LINEBREAK);
            buf.append("    (doublefield " + dbvar + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
    ...
    public void write5JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("    (shortfield " + shrtvar + ")" + Constants.LINEBREAK);
            buf.append("    (doublefield " + dbvar + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield2 " + strvar + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
    ...
    public void write10JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("    (doublefield " + dbvar + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield2 " + strvar + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield3 " + strvar3 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield4 " + strvar4 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield5 " + strvar5 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield6 " + strvar6 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield7 " + strvar7 + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
            buf.append("    (shortfield " + shrtvar + ")" + Constants.LINEBREAK);
            buf.append("    (doublefield " + dbvar + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield2 " + strvar2 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield3 " + strvar3 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield4 " + strvar4 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield5 " + strvar5 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield6 " + strvar6 + ")" + Constants.LINEBREAK);
    ...
    public void write15JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            buf.append("    (stringfield6 " + strvar6 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield7 " + strvar7 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield8 " + strvar8 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield9 " + strvar9 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield10 " + strvar10 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield11 " + strvar11 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield12 " + strvar12 + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
    ...
    public void write20JoinRule(int count, StringBuilder buf) {
        for (int idx = 1; idx <= count; idx++) {
            ...
            String strvar11 = "?strfld11" + idx;
            String strvar12 = "?strfld12" + idx;
            String strvar13 = "?strfld13" + idx;
            String strvar14 = "?strfld14" + idx;
            String strvar15 = "?strfld15" + idx;
            String strvar16 = "?strfld16" + idx;
            String strvar17 = "?strfld17" + idx;
            ...
            buf.append("    (stringfield11 " + strvar11 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield12 " + strvar12 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield13 " + strvar13 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield14 " + strvar14 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield15 " + strvar15 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield16 " + strvar16 + ")" + Constants.LINEBREAK);
            buf.append("    (stringfield17 " + strvar17 + ")" + Constants.LINEBREAK);
            buf.append("  )" + Constants.LINEBREAK);
            buf.append("  (object2" + Constants.LINEBREAK);
            buf.append("    (intfield " + intvar + ")" + Constants.LINEBREAK);
            buf.append("    (longfield " + lngvar + ")" + Constants.LINEBREAK);
