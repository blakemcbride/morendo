...
/**
 * Configuration describes the models, functions, rules and data for a given RuleApplication. For
 * each one, there could be one or more, so they all use lists.
 *
 * <p>the list could be text files, or other objects.
 *
 * @author Peter Lin
 */
