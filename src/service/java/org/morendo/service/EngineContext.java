...
/**
 * The purpose of an EngineContext is to encapsulate a rule engine instance so that when the request
 * or application is done, it returns the engine instance back to the application pool.
 *
 * @author Peter Lin
 */
public interface EngineContext {
     ...
     * @param isShadowed
     */
    void asssertObjects(List<Fact> data, boolean isStatic, boolean isShadowed)
    ...
    /**
     * In some cases, like embedding the engine in another application, the user may want direct
     * access to it. This functionality is for expert users and situations where the rule engine is
     * embedded. For normal applications, do not use this method.
     *
     * @return
     */
    Rete getRuleEngine();
