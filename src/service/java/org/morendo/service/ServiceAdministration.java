...
/**
 * The purpose of the ServiceAdministration interface is to provide a way to administer the
 * RuleService, and RuleApplications. The RuleService interface provides coarse grain method to
 * reload all engines for a given RuleApplication, but it doesn't give fine grain control.
 *
 * <p>The RuleService reload is there for convienance when you the user just wants to reload all the
 * engine for a given rule application.
 *
 * @author Peter Lin
 */
public interface ServiceAdministration {
    ...
    /**
     * Reload a specific rule application in the service. Concrete implementations should not reset
     * the statistics when a single rule application is reinitialized.
     *
    ...
    /**
     * Reload the ruleset for a given application in the service. All engines in the pool will be
     * reloaded.
     *
     * @param ruleApplication
     * @param version
