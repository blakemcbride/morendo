...
/**
 * Object model is only for compiled jar files containing the classes that need to be declared with
 * defclass.
 *
 * @author Peter Lin
 */
public class ObjectModel implements Model {
    ...
    /**
     * The URL for the jar file is optional and is only used if the jar isn't already in the
     * classpath.
     *
     * @param url
     */
    ...
    /**
     * The classes that implement jamocha's FunctionGroup interface.
     *
     * @param classList
     */
