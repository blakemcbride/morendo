...
import org.morendo.shell.Shell;

import javax.swing.SwingUtilities;

/**
 * Command-line entry point: "-shell" runs the interactive shell on the calling thread, "-gui" opens
 * the Swing GUI on the event dispatch thread; both may be given.
 */
public class Morendo {
    ...
    public void showUsage() {
        ...
        System.out.println(
                "You have to pass one or more of the following arguments:"
                        + sep
                        + sep
