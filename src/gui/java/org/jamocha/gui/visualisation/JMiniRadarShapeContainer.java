...
public final class JMiniRadarShapeContainer extends JShapeContainer implements MouseListener, MouseMotionListener, ComponentListener{
	...
	/**
	 * Sets the font height in pixels (normalized by the scaling factor,
	...
	/**
	 * @return the MasterShapeContainer. That the
	...
	/**
	 * sets the MasterShapeContainer. That the
	 * JShapeContainer which is controlled by
	 * this MiniRadar.
	...
	public void componentResized(ComponentEvent arg0) {
		...
		if (offsetX>offsetXmax) {offsetX=offsetXmax;weHadToChangeOffset=true;}
		if (offsetY>offsetYmax) {offsetY=offsetYmax;weHadToChangeOffset=true;}
		if (offsetX<0) {
