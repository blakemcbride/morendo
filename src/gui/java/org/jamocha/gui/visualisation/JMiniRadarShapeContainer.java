package org.jamocha.gui.visualisation;
...
/**
 * @author Josef Alexander Hahn A special JShapeContainer which can be used as mini-map. Here you
 *     can scroll in the network and the new offset is given to the MasterShapeContainer.
 */
public final class JMiniRadarShapeContainer extends JShapeContainer
    ...
    /**
     * Sets the font height in pixels (normalized by the scaling factor, which means, when
     * scaling-factor=1)
     *
     * @param h font height in pixels
     */
    ...
    /**
     * @return the MasterShapeContainer. That the JShapeContainer which is controlled by this
     *     MiniRadar.
     */
    ...
    /**
     * sets the MasterShapeContainer. That the JShapeContainer which is controlled by this
     * MiniRadar.
     *
     * @param masterShapeContainer The MasterShapeContainer
     */
    ...
    protected void radarNewPosition(int x, int y) {
        ...
        int offsetXmax =
                graphwidth + 10 - (int) (masterShapeContainer.getWidth() / masterZoomFactor);
        int offsetYmax =
                graphheight + 10 - (int) (masterShapeContainer.getHeight() / masterZoomFactor);
