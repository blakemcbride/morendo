...
/**
 * @author Josef Alexander Hahn This is a concrete Shape-Implementation for an rectangle with a
 *     topleft-point, a width, a height
 */
public class Rectangle extends Shape {
     ...
     */
    public Rectangle(
            Color bgcolor, Color bordercolor, int x, int y, int width, int height, String text) {
    ...
    /**
     * Draws the rectangle. The draw-position is translated by (-offsetX,-offsetY).
     *
    ...
    /**
     * Draws the rectangle. The draw-position is translated by (-offsetX,-offsetY) and scaled by
     * (factorX,factorY).
     *
     * @param canvas The canvas to draw the arrow on
     * @param offsetX Translation-Vector's negative x-component
    ...
    /**
     * Draws the rectangle. The draw-position is scaled by (factorX,factorY).
     *
     * @param canvas The canvas to draw the arrow on
     * @param factorX Scaling-Vector*s x-component
     * @param factorY Scaling-Vector*s y-component
    ...
    /**
     * Calculates the intersection-coordinate between the borderline of that shape and a line,
     * starting in the centre with the given angle
     *
