...
/**
 * @author Josef Alexander Hahn This is a concrete Shape-Implementation for an ellipse with a
...
public class Ellipse extends Shape {
    ...
    /**
     * Draws the ellipse. The draw-position is translated by (-offsetX,-offsetY).
     *
    ...
    /**
     * Draws the ellipse. The draw-position is translated by (-offsetX,-offsetY) and scaled by
     * (factorX,factorY).
     *
     * @param canvas The canvas to draw the arrow on
     * @param offsetX Translation-Vector's negative x-component
    ...
    /**
     * Draws the ellipse. The draw-position is scaled by (factorX,factorY).
     *
     * @param canvas The canvas to draw the arrow on
     * @param factorX Scaling-Vector*s x-component
     * @param factorY Scaling-Vector*s y-component
