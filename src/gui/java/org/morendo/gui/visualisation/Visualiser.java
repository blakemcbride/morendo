...
import org.morendo.rete.AlphaNodePredConstr;
...
/**
 * @author Josef Alexander Hahn a class which can visualise a rete-network this class does not
...
public final class Visualiser implements ActionListener, MouseListener, EngineEventListener {
        ...
        if (reteNode == null) {
            ...
            longdesc =
                    "ID:"
                            + reteNode.getNodeId()
                            + "  NodeType:"
                            + reteNode.getClass().getSimpleName();
    ...
    public JPanel getVisualiserPanel() {
        ...
        zoomInButton =
                new JButton(
                        "Zoom In", IconLoader.getImageIcon("magnifier_zoom_in", Visualiser.class));
        zoomOutButton =
                new JButton(
                        "Zoom Out",
                        IconLoader.getImageIcon("magnifier_zoom_out", Visualiser.class));
        ...
        dump.setText(
                "This is the node dump area. Click on a node and you will get some information"
                        + " here\n");
        ...
        JSplitPane mainSplitPane =
                new JSplitPane(JSplitPane.VERTICAL_SPLIT, container, sideSplitPane);
        ...
        autoReloadButton =
                new JToggleButton("Automatic Reload", IconLoader.getImageIcon("arrow_refresh"));
