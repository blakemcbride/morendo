...
/**
 * @author Josef Alexander Hahn This is a concrete Shape-Implementation for an trapezoid with a
 *     topleft-point, a width, a height in that way, that the top line is 50% of the bottom line and
 *     centered.
 */
public class Trapezoid extends Shape {
    ...
    public void draw(Graphics2D canvas, int offsetX, int offsetY, double factorX, double factorY) {
        ...
        int[] xpoints = {
            ourX + (int) (ourWidth * .25), ourX + (int) (ourWidth * .75), ourX + ourWidth, ourX
        };
