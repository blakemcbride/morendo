...
import org.morendo.gui.editor.FactEditor;
...
/**
 * This Panel shows all facts currently in the Jamocha engine. You can assert new facts or retract
 * existing ones.
 *
...
public final class FactsPanel extends AbstractJamochaPanel
    ...
    private void initFactsList() {
        ...
        factsTable.getColumnModel().getColumn(1).setPreferredWidth(factsTable.getWidth() - 50);
    }

    private void initPopupMenu() {
        JPopupMenu menu = new JPopupMenu();
        JMenuItem retractItem =
                new JMenuItem(
                        "Retract selected Fact(s)", IconLoader.getImageIcon("database_delete"));
        retractItem.addMouseListener(
                new MouseAdapter() {
    ...
    private final class FactsTableModel extends AbstractTableModel {
        ...
        public Class<?> getColumnClass(int aColumn) {
            if (aColumn == 0) return java.lang.Number.class;
                ...
                if (fact != null) {
                    ...
                    for (BaseSlot slot : slots) {
                        ...
                        if (slot.getValueType() == ValueType.ARRAY) {
                            ...
                            buffer.append(
                                    Arrays.toString((Object[]) fact.getSlotValue(slot.getId())));
                        } else {
