...
public final class ShellSettingsPanel extends AbstractSettingsPanel implements ActionListener {
    ...
    public ShellSettingsPanel(JamochaGui gui) {
        ...
        fontsizes.setSelectedItem(gui.getPreferences().getInt("shell.fontsize", 12));
        ...
        fontColorChooserPreview.setBackground(
                new Color(gui.getPreferences().getInt("shell.fontcolor", Color.WHITE.getRGB())));
        fontColorChooserButton =
                new JButton("Choose Color", IconLoader.getImageIcon("color_swatch"));
        ...
        backgroundColorChooserPreview.setBackground(
                new Color(
                        gui.getPreferences()
    ...
    @Override
    public void save() {
        gui.getPreferences().put("shell.font", ((Font) fonts.getSelectedItem()).getFontName());
        gui.getPreferences().putInt("shell.fontsize", (Integer) fontsizes.getSelectedItem());
        gui.getPreferences()
                .putInt(
                        "shell.fontcolor",
