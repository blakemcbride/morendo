...
/**
 * Shared conversions for the time functions. Points in time are java.time.Instant;
 * java.util.Date and Calendar values from Java beans, numbers (epoch milliseconds)
 * and ISO-8601 strings are accepted as input as well.
 */
public abstract class AbstractTimeFunction {
	...
	/**
	 * Parses an ISO-8601 instant ("2026-09-12T13:41:44Z"), an offset or zoned
	 * date-time, or a local date-time (taken in the system time zone).
	 */
