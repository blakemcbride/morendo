 ...
 * @author Peter Lin
 */
public class EqSecondFunction extends AbstractTimeFunction implements Function {

	/**
	 * 
	 */
	public static final String EQ_SECOND = "eq-second";
	
	public EqSecondFunction() {
		super();
	}
		...
		if (params != null && params.length == 2) {
			...
			if (date1 != null && date2 != null) {
				...
				if (zoned1.getYear() == zoned2.getYear() &&
						...
						zoned1.getSecond() == zoned2.getSecond()) {
					eval = Boolean.TRUE;
				}
			}
		}
