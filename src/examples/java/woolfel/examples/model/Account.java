...
/**
 * @author Peter Lin
 *     <p>A simple test bean that represents a generic account. It could be a bank account, shopping
 *     card account, or any type of membership account with a nationwide company.
 */
public class Account implements IAccount, Serializable {
    ...
    /** this would represent the region of the office the account was opened at. */
