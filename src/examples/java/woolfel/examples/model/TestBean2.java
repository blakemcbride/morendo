...
/**
 * @author Peter Lin
 *     <p>Alternate version of TestBean that does implement add/remove PropertyChangeListener. It
 *     doesn't implement the necessary calls in the set methods to notify the rule engine
 */
